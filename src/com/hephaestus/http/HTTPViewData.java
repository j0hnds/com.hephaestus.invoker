...
public interface HTTPViewData {
	...
	/**
	 * Returns the host/port of the proxy to use to make the call.
	 * 
	 * @return host/port of proxy formatted as "host:port". null or empty 
	 * string if no proxy is set.
	 */
	String getProxyHostPort();
	
	/**
	 * Returns flag indicating if strict SSL handling should be enforced.
	 * 
	 * @return true if strict SSL handling should be enforced. False if
