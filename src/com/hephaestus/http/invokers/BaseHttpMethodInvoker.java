...
public abstract class BaseHttpMethodInvoker implements HttpMethodInvoker, Protocols {
	...
	public void invoke(HTTPViewData viewData) {
		...
		HttpClient client = getClient(viewData);
		HttpMethod method = null;
		if (isStrictSSL(viewData) || HTTP.equals(protocol)) {
	 ...
	 */
	protected boolean isStrictSSL(HTTPViewData viewData) {
		return viewData.isStrictSSL();
	}
